...
Applies to every module listed in `node_modules/@wolfgames/components/src/modules/INDEX.md` — primitives, prefabs, and logic modules. The audit lives at [`tasks/agent-friendliness-audit.md`](../../tasks/agent-friendliness-audit.md).
